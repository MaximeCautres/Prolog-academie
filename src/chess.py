...
class Plateau:
    def __init__(self):
        ...
        self.numero_tour = 0
        # C'est petit mais le echec et mat c'est chiant à mettre en place
        self.abandon = False
...
while continuer:
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONDOWN and event.button == 1:
            x, y = event.pos
            i, j = x // unit, 7 - y // unit
            # Ici, on choisit un de nos pions
            if not selectionee:
...
# On netoie la merde que l'on fait
os.system("rm background.png case\_beige.png case\_marron.png case\_mangeage.png case\_deplacement.png case\_roque.png case\_selectionne.png")
