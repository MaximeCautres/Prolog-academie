    ...
    def __init__(self, unit)):
        ...
        def display(self):
            ...
            self.pieces_skin = {
                ...
                'rook': {True: pygame.transform.scale(pygame.image.load("../pictures/whiteRook.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) )), False: pygame.transform.scale(pygame.image.load("../pictures/blackRook.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) ))},
                'knight': {True: pygame.transform.scale(pygame.image.load("../pictures/whiteKnight.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) )), False: pygame.transform.scale(pygame.image.load("../pictures/blackKnight.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) ))}
                'bishop': {True: pygame.transform.scale(pygame.image.load("../pictures/whiteBishop.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) )), False: pygame.transform.scale(pygame.image.load("../pictures/blackBishop.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) ))},
                'king': {True: pygame.transform.scale(pygame.image.load("../pictures/whiteKing.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) )), False: pygame.transform.scale(pygame.image.load("../pictures/blackKing.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) ))},
                'queen': {True: pygame.transform.scale(pygame.image.load("../pictures/whiteQueen.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) )), False: pygame.transform.scale(pygame.image.load("../pictures/blackQueen.png").convert_alpha(), (int(unit * 0.8), int(unit * 0.8) ))}}
        ...
        def updateDisplay(self, to_update):
            for y, x in to_update:
                ...
                if self.map[y][x] != None:
                    ...
                    (int((x+0.1) * unit), int((7-y + 0.1) * unit)))
